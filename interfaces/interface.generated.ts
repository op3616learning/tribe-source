...
export var AppCollaboratorType;
...
export var CustomFieldPrivacyOptions;
...
export var CustomFieldValidators;
(function (CustomFieldValidators) {
    CustomFieldValidators["ALLOF"] = "allOf";
    CustomFieldValidators["ANYOF"] = "anyOf";
    CustomFieldValidators["ENUM"] = "enum";
    CustomFieldValidators["EXCLUSIVEMAXIMUM"] = "exclusiveMaximum";
    CustomFieldValidators["EXCLUSIVEMINIMUM"] = "exclusiveMinimum";
    CustomFieldValidators["FORMAT"] = "format";
    CustomFieldValidators["MAXITEMS"] = "maxItems";
    CustomFieldValidators["MAXLENGTH"] = "maxLength";
    CustomFieldValidators["MAXPROPERTIES"] = "maxProperties";
    CustomFieldValidators["MAXIMUM"] = "maximum";
    CustomFieldValidators["MINITEMS"] = "minItems";
    CustomFieldValidators["MINLENGTH"] = "minLength";
    CustomFieldValidators["MINPROPERTIES"] = "minProperties";
    CustomFieldValidators["MINIMUM"] = "minimum";
    CustomFieldValidators["MULTIPLEOF"] = "multipleOf";
    CustomFieldValidators["NOT"] = "not";
    CustomFieldValidators["ONEOF"] = "oneOf";
    CustomFieldValidators["PATTERN"] = "pattern";
    CustomFieldValidators["UNIQUEITEMS"] = "uniqueItems";
...
export var NetworkReleaseChannelType;
...
export var RelationTypeOptions;
...
(function (ReportSlug) {
    ...
    ReportSlug["TOTALPOSTS"] = "totalPosts";
    ReportSlug["TOTALREACTIONS"] = "totalReactions";
    ReportSlug["TOTALREPLIES"] = "totalReplies";
...
export var RichTextTypeOptions;
...
export var SlateEditable;
(function (SlateEditable) {
    SlateEditable["ADDCOMPONENT"] = "addComponent";
    SlateEditable["ALL"] = "all";
    SlateEditable["EDITCOMPONENT"] = "editComponent";
    SlateEditable["NONE"] = "none";
...
export var TextTypeOptions;
(function (TextTypeOptions) {
    TextTypeOptions["FULLTEXT"] = "fullText";
    TextTypeOptions["SHORTTEXT"] = "shortText";
