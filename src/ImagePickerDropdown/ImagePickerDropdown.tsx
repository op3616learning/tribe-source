...
const ImagePickerDropdown = ({ emojiSize = '2xs', image, imageBoxSize = 5, isDisabled = false, isLoading = false, offset = [0, 0], onEmojiSelect, onFileUpload, onLinkUpload, spinnerSize = '24px', }) => {
    ...
    return (React.createElement(Popover, { closeOnBlur: true, isLazy: true, isOpen: isOpen, modifiers: [
        ...
        React.createElement(PopoverTrigger, null,
            React.createElement(Box, { alignItems: "center", cursor: "pointer", "data-testid": "image-picker-dropdown", display: "inline-flex", justifyContent: "center", height: imageBoxSize, onClick: open, overflow: "hidden", width: imageBoxSize }, isLoading ? (React.createElement(Spinner, { height: spinnerSize, width: spinnerSize, mr: 0, thickness: "2px" })) : (React.createElement(Tooltip, { label: t('common:changeIcon', 'Change icon'), placement: "auto-start", textAlign: "center" },
