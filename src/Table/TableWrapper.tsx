...
export const TableWrapper = ({ children, columns, data, dataTestId, emptySearchResultComponent, emptyStateComponent, fetchMore, hasMore, hasTab = false, hasBorder = true, itemSize, loading, onSearch, searchPlaceholder, searchResult = false, showColumnsFilter = false, showFetchMoreButton = true, showHeaders = true, skeletonRowCount = 3, total, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TableStack, { borderWidth: hasBorder ? '1px' : '0px', "data-testid": dataTestId, borderTopRadius: hasTab && 'none' },
