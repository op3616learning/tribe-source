        ...
        React.createElement(DropdownList, null, options.map(item => {
            ...
            return (React.createElement(DropdownItem, { d: "flex", key: item.value, onClick: () => {
                ...
                React.createElement(Flex, { justifyContent: "space-between", flex: "1" },
                    ...
                    !((_a = item === null || item === void 0 ? void 0 : item.permission) === null || _a === void 0 ? void 0 : _a.authorized) &&
                        ((_b = item.permission) === null || _b === void 0 ? void 0 : _b.requiredPlan) && (React.createElement(PlanBadge, { plan: item.permission.requiredPlan, isAuthorized: item.permission.authorized })))));
        }))));
};
