...
export const DropdownItem = forwardRef((props, ref) => {
    const { icon, iconSpacing, children, danger, skipClickEvent, ...rest } = props;
    let dropdownItemProps = useMenuItem(rest, ref);
    if (skipClickEvent) {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const { onClick: _, ...itemProps } = dropdownItemProps;
        dropdownItemProps = itemProps;
    }
