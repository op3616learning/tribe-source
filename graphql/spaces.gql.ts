...
`;
export const SPACE_AUTH_MEMBER_PROPS = gql `
  fragment SpaceAuthMemberPropsFragment on SpaceAuthMemberProps {
    context
    membershipStatus
    permissions {
      ...PermissionAction
