...
import { Attachment, AttachmentModalProps } from './@types'
...
type ComposerProps = Pick<AttachmentModalProps, 'onAttachmentDownload'> & {
  value: string
  embeds?: Embed[] | null
...
const ComposerReadonlyInner = ({
  ...
  return (
    <>
      ...
      {/* Anything external right after the content (E.g: See more/See less) */}
      {children}
...
export const ComposerReadonly = memo(ComposerReadonlyInner)
