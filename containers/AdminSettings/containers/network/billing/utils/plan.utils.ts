...
export const isPlanDowngrade = (targetPlan, currentPlan): boolean => {
  const downgrades = {
    [PlanName.ENTERPRISE]: [PlanName.PREMIUM, PlanName.BASIC, PlanName.PLUS],
    [PlanName.PREMIUM]: [PlanName.PLUS, PlanName.BASIC],
    [PlanName.PLUS]: [PlanName.BASIC],
    [PlanName.BASIC]: [],
  }

  return downgrades[currentPlan].includes(targetPlan)
}
