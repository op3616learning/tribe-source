...
export const CreateSpaceContainer = () => {
          ...
          availablePostTypes: [
            {
              ...
              createdAt: new Date().toISOString(),
              id: `post-type-creating`,
              name: 'Discussion',
              pluralName: 'Discussions',
              slug: 'tribe-discussion',
              primaryReactionType: ReactionType.EMOJI_BASE,
              singleChoiceReactions: ['reaction'],
  ...
  }, [space, network, authUser, spaceCollections, queryCollectionId])
